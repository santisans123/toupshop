        ...
        <div id="modal" class="fixed inset-0 z-50 hidden overflow-auto bg-black bg-opacity-50">
            <div class="flex justify-center items-center min-h-screen">
                <div class="bg-white text-gray-800 p-8 rounded-lg w-96">
                    <!-- Modal Content -->
                    <h2 class="text-2xl font-bold mb-4">Edit Price Product</h2>
                    <form class="max-w-md mx-auto">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="relative">
                                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="w-52 dark:bg-gray-800 dark:text-gray-200 mt-1 border rounded-3xl flex items-center justify-between px-4 py-2">
                                    Dropdown button
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="py-2">
                                <input type="text" id="title" name="title" class="w-52 dark:bg-gray-200 dark:text-gray-200 mt-1 p-2 border rounded-3xl" placeholder="Judul Price">
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="py-2">
                                <input type="number" id="nominal" name="nominal" class="w-52 dark:bg-gray-200 dark:text-gray-200 mt-1 p-2 border rounded-3xl" placeholder="Nominal Price">
                            </div>
                        </div>
